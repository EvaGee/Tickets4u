	...
	foreach ($homescreen as $value) {
		?>
			<div id="deskstop-slider"><a href="<?php echo base_url(); ?>index.php/event?me=<?php echo $value['event_id']; ?>">
  			<img class="mySlides img-responsive" src="<?php echo $value['slider_image']; ?>">
			 <img class="mySlides img-responsive" src="assets/images/impactsalesslide.jpeg">
			  <img class="mySlides img-responsive" src="assets/images/slider1.jpg">
			  <img class="mySlides img-responsive" src="assets/images/coastohome.jpeg">
			  <img class="mySlides img-responsive" src="assets/images/traveltales.jpeg">
			  </a></div>
				...
				foreach ($thumbs as $value) {
					?>
						...
						<?php
							...
							?>
							<div class="card past-event" style=" grid-column: 1/-1; grid-row: 1/-1; filter: grayscale(100%); filter: gray;	padding-bottom:50px; height:400px;">
							  <img src="<?php echo $value['cover_image']; ?>" alt="<?php echo $value['event_title']; ?>" style=" filter: blur(1px); width:300px; height:250px;">
							  <div class="card-container" style="text-align: left;  filter: blur(1px); ">
							  	 <div style="font-size: 11px;"><b>Event:</b> <font style="color:#514848;"><?php echo $value['event_title']; ?></font></div> 
								<div style="font-size: 11px;"><b>Event Date:</b> <font style="color:#514848;"><?php echo $value['event_date']; ?></font></div> 
							  	 <div style="font-size: 11px;"><b>Location:</b> <font style="color:#514848;"><?php echo $value['event_venue']; ?></font></div> 
							 <button style="background-color: #4CAF50;border: none;color: white;padding: 5px 32px;text-decoration: none;display: inline-block;font-size: 16px;margin: 4px 2px;cursor: pointer;bottom: 4px;" class="button">Read more</button>
					...
					<div class="section-content">
						<ul class="row clearfix">
							...
							<li class="category-1 col-sm-2">
								...
								<img src="assets/images/event-category-4.jpg" style="width:250px; height:250px;">
